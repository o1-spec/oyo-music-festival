  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <p
          className="text-lg xs:text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto text-balance animate-fade-in"
        ...
        <div
          className="flex flex-col sm:flex-row items-center justify-center gap-4 xs:gap-6 mb-12 text-foreground animate-fade-in"
        ...
        <div
          className="absolute left-1/2 translate-y-20 cursor-pointer -translate-x-1/2 animate-fade-in"
