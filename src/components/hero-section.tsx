    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 -top-15">
          <span
            className="absolute text-4xl text-[#52f3fe] font-bold animate-drum-hit transform -rotate-12"
            style={{ top: "10%", left: "15%", animationDelay: "0s" }}
          >
            !
          </span>
          <span
            className="absolute text-4xl text-[#e223a5] font-bold animate-drum-hit transform"
            style={{ top: "10%", right: "56%", animationDelay: "1s" }}
          >
            !
          </span>
          <span
            className="absolute text-4xl text-[#52f3fe] font-bold animate-drum-hit transform rotate-20"
      ...
      >
        ...
        <div className="absolute inset-0 -top-5">
          <span
            className="absolute text-4xl text-[#52f3fe] font-bold animate-drum-hit transform rotate-60"
      ...
      >
        ...
        >
          <div className="flex flex-col items-center gap-2 text-muted-foreground">
            ...
            <div className="w-px h-8 xs:h-12 bg-gradient-to-b from-primary to-transparent animate-pulse" />
          </div>
        </motion.div>
      </motion.div>
      <style jsx>{`
