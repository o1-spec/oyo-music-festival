      ...
      <section className="py-10 sm:py-20 px-4">
        <div className="max-w-4xl mx-auto prose prose-invert prose-sm sm:prose-base lg:prose-lg">
          ...
          >
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-[#52f3fe] mb-4">2. Information We Collect</h2>
            <p className="mb-6 text-sm sm:text-base">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-[#52f3fe] mb-4">3. How We Use Your Information</h2>
            <p className="mb-6 text-sm sm:text-base">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-[#52f3fe] mb-4">4. Sharing Your Information</h2>
            <p className="mb-6 text-sm sm:text-base">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-[#52f3fe] mb-4">5. Data Security</h2>
            <p className="mb-6 text-sm sm:text-base">
              We implement industry-standard security measures to protect your data. However, no method of transmission over the internet is 100% secure.
            </p>

            <h2 className="text-xl sm:text-2xl font-bold text-[#52f3fe] mb-4">6. Your Rights</h2>
            <p className="mb-6 text-sm sm:text-base">
              You have the right to access, update, or delete your personal information. Contact us to exercise these rights.
            </p>

            <h2 className="text-xl sm:text-2xl font-bold text-[#52f3fe] mb-4">7. Contact Us</h2>
            <p className="mb-6 text-sm sm:text-base">
